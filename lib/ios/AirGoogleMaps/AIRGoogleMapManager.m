...
RCT_EXPORT_VIEW_PROPERTY(minimumClusterSize, int)
...
RCT_EXPORT_METHOD(addClusterMarkers:(nonnull NSNumber *)reactTag
...
RCT_EXPORT_METHOD(removeClusterMarkers:(nonnull NSNumber *)reactTag
                  items:(nonnull NSArray *) items)
{
  [self.bridge.uiManager addUIBlock:^(__unused RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    id view = viewRegistry[reactTag];
    if (![view isKindOfClass:[AIRGoogleMap class]]) {
      ...
      AIRGoogleMap *mapView = (AIRGoogleMap *)view;
      [mapView removeClusterItems:items];
    }
  }];
 }
...
RCT_EXPORT_METHOD(removeAllClusterMarker:(nonnull NSNumber *)reactTag)
{
  [self.bridge.uiManager addUIBlock:^(__unused RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    id view = viewRegistry[reactTag];
    if (![view isKindOfClass:[AIRGoogleMap class]]) {

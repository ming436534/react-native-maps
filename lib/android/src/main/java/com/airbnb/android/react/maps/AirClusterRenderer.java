 ...
 */
public class AirClusterRenderer<T extends AirClusterItem> implements ClusterRenderer<T>, AirIconManagerCallbacks {
     ...
     * Markers for single ClusterItems.
     */
    private Map<String, List<Marker>> uriToMarkerCache = new HashMap<>();
    ...
    public AirClusterRenderer(Context context, GoogleMap map, ClusterManager<T> clusterManager, View view) {
        mMap = map;
        mAnimate = true;
    ...
    @Override
    public void onBitmapDescriptorReady(BitmapDescriptor d, String uri) {
